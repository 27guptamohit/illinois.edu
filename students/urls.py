...
# addition/changes: Cleaned and organized version of urls.py
...
urlpatterns = [
    ...
    # -----------------------------------------------------------------------------------
    # WEEK 12: AUTHENTICATION (Login / Logout / Signup)
    # -----------------------------------------------------------------------------------
    path("login/", LoginView.as_view(template_name="students/login.html"), name="login_urlpattern"),
    ...
    # -----------------------------------------------------------------------------------
    # WEEK 12: AUTHENTICATED LIST & DETAIL VIEWS (Protected by LoginRequiredMixin)
    # -----------------------------------------------------------------------------------
    ...
    path("student/<int:primary_key>/", views.StudentDetail.as_view(), name="student-detail-url"),

    # -----------------------------------------------------------------------------------
    # WEEK 10: FORM HANDLING (Feedback + Add Student)
    # -----------------------------------------------------------------------------------
    ...
    # -----------------------------------------------------------------------------------
    # WEEK 8: CHARTS (Matplotlib visualizations)
    # -----------------------------------------------------------------------------------
    ...
    # -----------------------------------------------------------------------------------
    # WEEK 11: JSON API ENDPOINTS (Data for charts and AJAX)
    # -----------------------------------------------------------------------------------
