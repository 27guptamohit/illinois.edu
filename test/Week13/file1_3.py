...
# New addition/changes: signup_urlpattern
from django.contrib.auth.views import LoginView, LogoutView
from django.urls import path

from . import views  # single import: use views.X everywhere
from .views import (StudentCreateView, StudentsAPI,
                    enrollments_chart_png, EnrollmentsChartPage, WeatherNow, ReportsView, export_students_csv,
...
urlpatterns = [
    ...
    # new addition/changes: auth routes
